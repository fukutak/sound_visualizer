...
class PlotWindow:
    def __init__(self):
        ...
        self.key = ['　ド　', '　ド＃', '　レ　', '　レ＃', '　ミ　', 'ファ　',
                    'ファ＃', '　ソ　', '　ソ＃', '　ラ　', '　ラ＃', '　シ　']
        # 新しい色の定義 [153, 114, 35], # re_b [0, 129, 65], # mi_b [27, 125, 160], # so_b [99, 55, 140],
        # ra_b [163, 116, 162], # si_b
    ...
    def update(self):
        self.data = np.append(self.data, self.audio_input())  # これがプロットデータ？？
        self.a = 3
